...
<img src='http://i.imgur.com/uVqR4js.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Had trouble implementing the require_login() function on most of the pages. Still doesn't process the page correctly and keeps leading back to index page. 
